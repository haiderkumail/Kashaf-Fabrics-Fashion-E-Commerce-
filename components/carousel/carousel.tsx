        ...
        {featuredProducts.length > 0 ? (
          featuredProducts.map((product) => (
            <CarouselItem key={product._id} className="!m-0 !p-0 w-screen max-w-none">
              <div className="relative h-[500px] sm:h-[304px] lg:h-[536px] w-full overflow-hidden m-0 p-0">
          ...
          <CarouselItem className="!m-0 !p-0 w-screen max-w-none">
            <div className="relative h-[500px] sm:h-[304px] lg:h-[536px] w-full overflow-hidden m-0 p-0">
              ...
              {/* Overlay Text */}
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white bg-black/30 px-2 sm:px-4">
